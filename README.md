...
```bash
npm install -g https://github.com/molivera-proguide/proguide-test/releases/download/v0.1.7/proguide-test-0.1.7.tgz
```

For private repositories:

```bash
gh release download v0.1.7 --repo molivera-proguide/proguide-test --pattern "proguide-test-*.tgz" --dir .
npm install -g ./proguide-test-0.1.7.tgz
```
...
The workflow runs tests, creates `proguide-test-0.1.7.tgz`, uploads it as a workflow artifact, and attaches it to the GitHub Release.
