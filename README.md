...
```bash
npm install -g ./proguide-test-0.2.0-ts.11.tgz
```

Tambien podes instalar directo desde GitHub Releases:

```bash
npm install -g https://github.com/molivera-proguide/proguide-test/releases/download/v0.2.0-ts.11/proguide-test-0.2.0-ts.11.tgz
```
